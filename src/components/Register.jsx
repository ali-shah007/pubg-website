...
function Register() {
  ...
  return (
    <div name='register' className='sm:h-screen wrapper relative w-full  flex justify-center items-center'>
          ...
          <div className="bg-white bg-opacity-90 rounded-md p-8">
            <form onSubmit={sendEmail} >
              ...
              <select name="tournament" className='bg-transparent px-4 py-2 rounded-md mb-4 block w-full' required>
                ...
                <option value="tournament1">Squad Tournament 10k Sunday</option>
              </select>
